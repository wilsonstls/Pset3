...
/*Date:  2-01-2015
*By:  Kevin Wilson
*Pset3 problem for Java launchCode class - demonstrate the Factory Design Pattern
...
public class Mario
{
    ...
    {  
        ...
        PyramidTypeFactory typeFactory = new PyramidTypeFactory();           // create Pyramid type Factory
